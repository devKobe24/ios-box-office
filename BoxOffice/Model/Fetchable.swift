        ...
        do {
            ...
            networkManager.getBoxOfficeData(requestURL: urlRequest) { [weak self] (boxOffice: BoxOffice) in
                ...
                for index in 1...count {
                    print(index-1)
                    var rankNumber = boxOffice.boxOfficeResult.dailyBoxOfficeList[index-1].rankNumber
                    var rankIntensity = boxOffice.boxOfficeResult.dailyBoxOfficeList[index-1].rankIntensity
                    var movieName = boxOffice.boxOfficeResult.dailyBoxOfficeList[index-1].movieName
                    var audienceCount = boxOffice.boxOfficeResult.dailyBoxOfficeList[index-1].audienceCount
                    var audienceAccumulated = boxOffice.boxOfficeResult.dailyBoxOfficeList[index-1].audienceAccumulated
